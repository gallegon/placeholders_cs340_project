INSERT INTO `Users` (firstName, lastName, latitude, longitude) VALUES 
('Seth', 'Houchins', 44.5642, 123.2621),
('Nicholai', 'Gallegos', 44.5631, 123.2591),
('Jabob', 'Hawkins', 44.5599, 123.2620),
('Jethro', 'Dowzers', 50.0239, 145.023),
('Dorkin', 'Borkin', 60.1234, 120.1234),
('Sensual', 'Sasquatch'),
('Your', 'Mom', 69.6969, 69.4200),
('Hewbert', 'Cumberdale', 90.0000, 0.0000),
('Puberman', 'Chimball', 89.2321, 45.0000),
('Wheresmabutt', 'Immachild', 23.1232, 167.2301),
('Icantthinkofanygoodnames', 'fart', 12.1212, 67.7348),
('Ithoughtofsomething', 'funnierthantwentyfour', 25.2525, 25.2525),
('Doot', 'Boop', 62.3512, 10.2412),
('Steve', 'Chiliman', 47.2536, 122.4444);
...
INSERT INTO `Tickets` (ticketID, ownerID, eventID, confirmedArrival) VALUES
(1, 1, 2, 0),
(2, 1, 5, 0),
(3, 2, 1, 0),
(4, 7, 1, 1),
...
INSERT INTO `Tags_Events` (tagName, eventID) VALUES
('Food', 1),
('Food', 2),
('Food', 4),
('Food', 3),
...
INSERT INTO `Users_Users` (followedBy, followedUser) VALUES
(1, 2),
(2, 1),
(1, 8),
(1, 7),
...
('Jethro', 'Dowzers', 50.0239, 145.023),
('Dorkin', 'Borkin', 60.1234, 120.1234),
('Sensual', 'Sasquatch', 000.0000, 000.00000),
('Your', 'Mom', 69.6969, 69.4200),
('Hewbert', 'Cumberdale', 90.0000, 0.0000),
('Puberman', 'Chimball', 89.2321, 45.0000),
('Wheresmabutt', 'Immachild', 23.1232, 167.2301),
